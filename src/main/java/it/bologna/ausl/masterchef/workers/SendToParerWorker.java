...
//                password = config.getProperty("sendtoparer.password", "gt67HFVk");
...
//                password = config.getProperty("sendtoparertest.password", "gedi_ausl_bo_pre_pw0");
        ...
        try {
            if (command.equalsIgnoreCase("insert")) {
                if (ambiente.equalsIgnoreCase("prod")) {
                    ...
                    password = config.getProperty("sendtoparer.insert.password", "gt67HFVk");
                    ...
                    password = config.getProperty("sendtoparer.test.insert.password", "gedi_ausl_bo_pre_pw0");
                ...
                if (ambiente.equalsIgnoreCase("prod")) {
                    ...
                    password = config.getProperty("sendtoparer.update.password", "gt67HFVk");
                    ...
                    password = config.getProperty("sendtoparer.test.update.password", "gedi_ausl_bo_pre_pw0");
